...
- Made loopback endpoint-leak assertions collision-safe and gave the buffered interleaving fixture enough request time on every supported Node.js line, removing two probabilistic CI failures without changing runtime limits.
