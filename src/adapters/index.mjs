const ADAPTERS = Object.freeze([
  ...
  adapter('ahp', 'Agent Host Protocol', 'Observe bounded AHP 0.8.0 root/session/chat metadata into redacted local evidence; never dispatches actions, exposes control methods, authenticates, spends, settles, publishes, or mutates trust.', ['loopback_endpoint_or_injected_transport', 'channel_allowlist', 'duration_or_event_limit', 'output_directory'], { status: 'observer', authority: 'local_no_spend_observation_only', entrypoint: 'agoragentic-harness-core/adapters/ahp' }),
